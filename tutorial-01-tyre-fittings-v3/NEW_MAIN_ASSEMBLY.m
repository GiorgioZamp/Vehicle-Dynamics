...
exportgraphics(f,'Graphs/Fy0.eps')
...
hold off
exportgraphics(f,'Graphs/Fy0_dFz.eps')
...
TDataTmp = intersect_table_data(FZ_220,P_80); 

% Initialise values for parameters to be optimised
%    [pDy3,pEy3,pEy4,pHy3,pKy3,pVy3,pVy4]
P0 = [0,0,0,-0.05,0.2,-1,-1]; 
lb = [];
ub = [];
...
legend(leg,Location="best")
hold off
exportgraphics(f,'Graphs/Fy0_gamma.eps')
